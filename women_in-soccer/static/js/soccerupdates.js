d3.select("#womensfifa").selectAll("div")
  ...
  .append("h3")
  .html(function(d) {
    return `<h3 style="color:red"> <strong>FIFA Ranking: ${d.fifa_ranking}</strong> </h3> <p>Wins: ${d.wins}, Losses: ${d.losses}, Draws: ${d.draws}, Goals: ${d.goals}</p> <footer><i>as of ${d.date}</i></footer><br>
    Latest: <a href="${d.story_link}">${d.recent_news}</a>, ${d.time_of_story}`
  });
